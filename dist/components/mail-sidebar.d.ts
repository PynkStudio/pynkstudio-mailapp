...
export declare function MailSidebar({ view, brand, unreadCount, unreadMine, canCompose, mode, mineAvailable, onViewChange, onBrandChange, onCompose, onOpenDeviceSettings }: Props): import("react").JSX.Element;
export {};
