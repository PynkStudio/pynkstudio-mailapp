...
import { Archive, AlertTriangle, Briefcase, Clapperboard, Heart, Inbox, LifeBuoy, Mail, MailOpen, Pencil, Send, Settings, ShieldAlert, Star, UtensilsCrossed, UserCheck, } from "lucide-react";
...
export function MailSidebar({ view, brand, unreadCount, unreadMine, deliveryIssueCount = 0, canCompose, mode = "platform", mineAvailable = true, onViewChange, onBrandChange, onCompose, onOpenDeviceSettings }) {
